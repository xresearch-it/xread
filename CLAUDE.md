# CLAUDE — xpaper (`@xresearch/xpaper`)
...
- **Identity = `@xresearch/xpaper`** — the workspace package name, stable regardless of where this repo physically lives. Imports never change when the repo moves.
